...
코딩 모드의 승인 단계에서는 바로 승인하거나 보류한 뒤 질문/수정 요청을 남길 수 있고,
확인 담당 에이전트가 다시 답변한 뒤 승인 대기를 이어갑니다.
...
| `ROUNDTABLE_TRANSCRIPT_WINDOW` | 3 | 매 턴 프롬프트에 직접 넣는 최근 메시지 개수 |
| `ROUNDTABLE_MEMORY_BRIEF_LINES` | 18 | 매 턴 프롬프트에 넣는 압축 요약 줄 수 |
